...
<div id="page_admin_add_manager_page_ek1"  >
	...
	<div id="form_ek1"  >
		<form class="addManagerForm" action="admin_add_manager_action.php" method="post">
		<div id="aaddmanagercontainer"  ></div>
		<div id="first_name__ek1" >
			First Name:
		</div>
		<div id="aaddmanagerfnamebox"  >
			<input type="text" id="addmanagerfname" name="addmanagerfname" required>
		</div>
		<div id="last_name__ek1" >
			Last Name:
		</div>
		<div id="aaddmanagerlnamebox"  >
			<input type="text" id="addmanagerlname" name="addmanagerlname" required>
		</div>
		<div id="manager_id_" >
			Manager ID:
		</div>
		<div id="aaddmanageridbox"  >
			<input type="text" id="addmanagerid" name="addmanagerid" required>
		</div>
		...
		<div id="email_idbox1"  >
			<input type="text" id="addemailid" name="addemailid" required>
		</div>
